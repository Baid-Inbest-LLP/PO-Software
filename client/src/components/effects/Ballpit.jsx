...
class x {
  ...
  dispose() {
    ...
    // Avoid forceContextLoss — React Strict Mode remounts reuse the same
    // canvas and cannot recover a lost WebGL context.
...
function createBallpit(e, t = {}) {
  ...
  i.renderer.toneMappingExposure = 1;
...
const Ballpit = ({ className = '', followCursor = true, ...props }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('[Ballpit] init failed:', err);
