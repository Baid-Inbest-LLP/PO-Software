...
const StatCard = ({ label, value, color, iconWrapClass, icon, accent }) => (
  <div className="card w-full p-3 sm:p-4 xl:p-5 max-[1660px]:p-4 max-[1536px]:p-3 max-[1366px]:p-[10px] max-[1280px]:p-2.5 flex items-center gap-2 sm:gap-3 xl:gap-4 max-[1660px]:gap-2.5 max-[1536px]:gap-2 max-[1366px]:gap-1.5 group hover:shadow-md transition-shadow duration-200 relative overflow-hidden">
    ...
    <div className={`w-10 h-10 sm:w-12 sm:h-12 xl:w-14 xl:h-14 max-[1660px]:w-12 max-[1660px]:h-12 max-[1536px]:w-11 max-[1536px]:h-11 max-[1366px]:w-10 max-[1366px]:h-10 max-[1280px]:w-9 max-[1280px]:h-9 rounded-xl flex items-center justify-center shrink-0 ${iconWrapClass}`}>
      {icon}
    </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[11fr_9fr] min-[1441px]:grid-cols-3 gap-4 sm:gap-5">
        ...
        <div className="card lg:col-span-1 min-[1441px]:col-span-2 overflow-hidden">
          <div className="px-4 sm:px-6 py-3 sm:py-4 max-[1440px]:sm:px-4 max-[1440px]:sm:py-3 border-b border-gray-100 bg-gray-50 flex items-center gap-2 sm:gap-3">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg dash-icon dash-icon-sky flex items-center justify-center shrink-0">
        ...
        <div className="card lg:col-span-1 min-[1441px]:col-span-1 overflow-hidden">
          <div className="px-4 sm:px-6 py-3 sm:py-4 max-[1440px]:sm:px-4 max-[1440px]:sm:py-3 border-b border-gray-100 bg-gray-50 flex items-center gap-2 sm:gap-3">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg dash-icon dash-icon-violet flex items-center justify-center shrink-0">
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[11fr_9fr] min-[1441px]:grid-cols-3 gap-4 sm:gap-5">
        ...
        <div className="card lg:col-span-1 min-[1441px]:col-span-2 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg dash-icon dash-icon-indigo flex items-center justify-center shrink-0">
          ...
          <div className="divide-y divide-gray-50">
            ...
            {dashboard?.recentOrders?.slice(0, 3).map((order) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-lg dash-icon dash-icon-indigo flex items-center justify-center flex-shrink-0">
        ...
        <div className="card lg:col-span-1 min-[1441px]:col-span-1 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 bg-gray-50 flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg dash-icon dash-icon-emerald flex items-center justify-center shrink-0">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
            </div>
